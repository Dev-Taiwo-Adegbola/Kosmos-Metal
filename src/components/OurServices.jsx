    ...
    <section className="pt-10 p-5 px-5 md:px-10 lg:px-20 flex flex-col gap-8 items-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <div className="bg-white p-5 rounded-lg shadow relative">
          ...
          />
          <h3 className="mt-3 text-xl font-bold text-[#BD0C0B]">
            Kerosene Tanker Fabrication
          </h3>
          <p
            tabIndex={0}
            className="text-white absolute bg-amber-800 flex flex-col justify-center  text-center p-10 inset-0 opacity-0 hover:opacity-100 max-lg:focus:opacity-100 transition"
          >
            <span className="text-xl font-bold ">
              Kerosene Tanker Fabrication
            </span>
            We design and fabricate high-capacity kerosene tankers engineered
            for safe transportation and long-term durability. Our tankers are
            built using quality steel materials and tested to withstand Nigerian
        ...
        <div className="bg-white p-5 rounded-lg shadow relative">
          ...
          >
            ...
            fabricated to support secure fuel transportation for distributors
        ...
        <div className="bg-white p-5 rounded-lg shadow relative">
          ...
          >
            ...
            petroleum products and industrial liquids. Our tanks are designed
            for strength, leak prevention, and operational efficiency.
          </p>
        </div>
        ...
        <div className="bg-white p-5 rounded-lg shadow relative">
          ...
          >
            ...
            strong, weather-resistant structures that enhance station safety and
            aesthetics.
          </p>
        </div>
