    ...
    <footer className="flex flex-wrap gap-15 py-15 px-5 md:px-10 lg:px-20  items-start bg-gray-100">
      <div className="flex flex-col-reverse gap-8 w-full md:w-[45%] lg:w-[30%]">
        <ul className="flex flex-col gap-4 text-sm font-semibold text-gray-700">
            <span className="block text-lg font-bold text-gray-800">Contact Information</span>
          <li>
          ...
          <li>
            ...
            <a href="tel:+2348037772798" className="text-gray-700">+234 803 777 2798</a>
          </li>
          <li>
      ...
      <div className="flex flex-col gap-8 ">
        ...
        <div className="flex flex-col gap-4">
          ...
          <ul className="flex gap-4">
            <li>
              <a href="#facebook" className="text-gray-700">Facebook</a>
            </li>
            <li>
              <a href="#twitter" className="text-gray-700">Twitter</a>
            </li>
            <li>
              <a href="#linkedin" className="text-gray-700">LinkedIn</a>
            </li>
          </ul>
        </div>
      </div>
