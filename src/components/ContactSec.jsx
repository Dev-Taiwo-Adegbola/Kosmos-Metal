const ContactSec = () => {
  return (
    ...
    >
        ...
        <p className="text-white text-center">Email: info@kosmos.com</p>
        <p className="text-white text-center">
          Just one call away: <a href="tel:+2348037772798">+234 803 777 2798</a>
        </p>
        <button className="mt-5 px-10 py-3 bg-blue-600 text-white rounded-4xl font-semibold hover:bg-[#BD0C0B] transition">
          Get in Touch
        </button>
